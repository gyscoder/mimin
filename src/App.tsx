...
const PHOTOS: Photo[] = [
  { src: "${import.meta.env.BASE_URL}photos/mimin-1.jpeg", alt: "Mimin", caption: "Mimin sendo Mimin.", className: "portrait tall" },
  { src: "${import.meta.env.BASE_URL}photos/mimin-2.jpeg", alt: "Mimin no espelho", caption: "Simplesmente ela. ❤️", className: "portrait" },
  { src: "${import.meta.env.BASE_URL}photos/mimin-3.jpeg", alt: "Mimin no espelho", caption: "A mais linda de todas. ❤️", className: "portrait" },
  { src: "${import.meta.env.BASE_URL}photos/mimin-4.jpeg", alt: "Mimin no espelho", caption: "Linda igual a mãe dela. ❤️", className: "portrait" },
  { src: "${import.meta.env.BASE_URL}photos/mimin-5.jpeg", alt: "Mimin no espelho", caption: "Nossa família linda! ❤️", className: "portrait" },
